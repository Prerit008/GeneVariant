    ...
    <div className="space-y-6 bg-slate-50 p-6 rounded-2xl">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <div className="grid grid-cols-2 divide-x divide-slate-100">
          <div className="px-6 py-4">
            <p className="text-xs text-slate-500 mb-1">Total Variants</p>
            <p className="text-2xl font-semibold text-slate-900">{allVariants.length}</p>
          </div>
          <div className="px-6 py-4">
            <p className="text-xs text-slate-500 mb-1">Genes Analyzed</p>
            <p className="text-2xl font-semibold text-slate-900">{data.pharmacogenomic_profile?.length || 0}</p>
          </div>
          {/* <div className="px-6 py-4">
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="col-span-2">
          <div className="bg-gradient-to-br from-slate-50 to-white p-6 rounded-2xl shadow-sm border border-slate-200 h-full">
            <div className="flex items-start space-x-4">
              <div className="w-10 h-10 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-xl flex items-center justify-center shadow-lg shadow-cyan-200">
              ...
              <div className="flex-1">
                ...
                <p className="text-slate-700 leading-relaxed">{data.clinical_recommendation?.recommendation}</p>
        ...
        <div className="px-6 py-4 border-b border-slate-200 bg-gradient-to-r from-slate-50 to-white">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold text-slate-900">
              <i className="fas fa-dna mr-2 text-cyan-600"></i>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        <div className="px-6 py-4 border-b border-slate-200 bg-gradient-to-r from-slate-50 to-white">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold text-slate-900">
              <i className="fas fa-table mr-2 text-cyan-600"></i>
              Detected Variants
            </h3>
          </div>
        </div>
                ...
                <tr key={index} className="hover:bg-slate-50 transition-colors group">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="w-6 h-6 bg-slate-100 rounded-lg flex items-center justify-center mr-3 group-hover:bg-cyan-100 transition-colors">
                        <i className="fas fa-dna text-xs text-slate-500 group-hover:text-cyan-600"></i>
                      </div>
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-indigo-600 mt-0.5">Generated by GeneVariant AI</p>
              </div>
            </div>
          </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4">
                ...
                {data.llm_generated_explanation.details && (
                  <div className="mt-4 pt-4 border-t border-indigo-100">
                    ...
                    <p className="text-sm text-slate-600">{data.llm_generated_explanation.details}</p>
                  </div>
                )}
